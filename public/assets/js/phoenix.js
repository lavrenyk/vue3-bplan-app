(function (global, factory) {
          ...
          t.forEach((t) => {
            ...
            d.on("updated", (e) => {
              const i =
                ...
                document.getElementById(a.fallback);
              i &&
                (0 === e.matchingItems.length
            ...
            const p = () => {
              c &&
                ...
                n && togglePaginationButtonDisable(n, 1 === v),
                l && togglePaginationButtonDisable(l, v === b),
                v > 1 &&
                  v < b &&
                  ...
                  .addEventListener("click", (e) => {
                    if ("page" === e.target.classList[0]) {
                      ...
                      t &&
                        (d.show(u * (t - 1) + 1, m),
                        (m =
                          d.visibleItems.length < u
                            ? u * (t - 1) + d.visibleItems.length
                            : u * t),
                        (v = t),
                        p());
                    }
            ...
            if (i) {
              window.phoenix.BulkSelect.getInstance(i).attachRowNodes(
                d.items.map((e) =>
  ...
  const handleNavbarVerticalCollapsed = () => {
    const {
      ...
      s = ".navbar-vertical .navbar-collapse",
      i = ".navbar-vertical .nav-link.active",
      v = "click",
      d = "mouseover",
      m = "mouseleave",
      u = "navbar.vertical.toggle",
      b = "navbar-vertical-collapsed",
      h = "navbar-vertical-collapsed-hover",
      g = document.querySelector(c),
      p = document.querySelector(l),
      y = document.querySelector(s),
      E = document.querySelector(i),
      L = e("phoenixIsNavbarVerticalCollapsed", !1);
    g &&
      g.addEventListener(v, (e) => {
        g.blur(),
          p?.classList.toggle(b),
          a("phoenixIsNavbarVerticalCollapsed", !L);
        const t = new CustomEvent(u);
        e.currentTarget?.dispatchEvent(t);
      }),
      y &&
        (y.addEventListener(d, () => {
    ...
    const S = () => {
      const e = document.querySelector(r).offsetHeight,
        t = document.querySelector(n)?.offsetHeight;
      document.documentElement.classList.contains(b) && e < t
    ...
    S(),
      ...
      g &&
        g.addEventListener("navbar.vertical.toggle", () => {
          S();
        });
  };
  ...
  const sortableInit = () => {
    const t = document.querySelectorAll("[data-sortable]"),
      e = document.querySelector("[data-kanban-container]");
    e &&
            ...
            switch (
              ...
              case "phoenixNavbarVerticalStyle":
                a.classList.remove("navbar-darker"),
                  "default" !== d && a.classList.add(`navbar-${d}`);
                break;
              case "phoenixNavbarTopStyle":
                r.classList.remove("navbar-darker"),
                  "transparent" !== d && r.classList.add(`navbar-${d}`);
                break;
